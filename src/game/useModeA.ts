...
import { midiAt, type PitchClass } from '../core/notes';
import { candidatePositions, isCorrect, nextQuestion, type Question, type QuizSettings } from '../core/quiz';

export type Phase = 'idle' | 'asking' | 'correct';
