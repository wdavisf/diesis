// Renders public/icon.png (apple-touch-icon) and public/og.png (link preview) from the logo SVG.
// Run with `npm run icons` after changing the mark in public/favicon.svg.
...
// The mark, then the name and the line, on the stage. Fonts come from the system.
...
const og = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="420" y="372" font-family="Helvetica Neue, Helvetica, Arial, sans-serif" font-size="40" fill="#a39c8e">Know every note on the guitar neck.</text>
...
console.log('wrote public/icon.png and public/og.png');
